...
class DataValidation:
    ...
    def preprocess_data(self):
        try:
            ratings = pd.read_csv(self.data_validation_config.ratings_csv_file, encoding='ISO-8859-1', sep=';', on_bad_lines='skip', low_memory=False)
            books = pd.read_csv(self.data_validation_config.books_csv_file, encoding='ISO-8859-1', sep=';', on_bad_lines='skip', low_memory=False)
